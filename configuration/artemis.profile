...
ARTEMIS_HOME='/home/adongre/Music/Location2/amq_brokers/amq-broker-7.6.0'
ARTEMIS_INSTANCE='/home/adongre/Music/Location2/amq_brokers/amq-broker-7.6.0/bin/sample-broker'
ARTEMIS_DATA_DIR='/home/adongre/Music/Location2/amq_brokers/amq-broker-7.6.0/bin/sample-broker/data'
ARTEMIS_OOME_DUMP='/home/adongre/Music/Location2/amq_brokers/amq-broker-7.6.0/bin/sample-broker/log/oom_dump.hprof'

# The logging config will need an URI
# this will be encoded in case you use spaces or special characters
# on your directory structure
ARTEMIS_INSTANCE_URI='file:/home/adongre/Music/Location2/amq_brokers/amq-broker-7.6.0/bin/sample-broker/'
ARTEMIS_INSTANCE_ETC_URI='file:/home/adongre/Music/Location2/amq_brokers/amq-broker-7.6.0/bin/sample-broker/etc/'
...
# Java Opts
JAVA_ARGS=" -XX:+PrintClassHistogram -XX:+UseG1GC -Xms512M -Xmx2G -Dhawtio.realm=activemq  -Dhawtio.offline=true -Dhawtio.role=amq,readonly -Dhawtio.rolePrincipalClasses=org.apache.activemq.artemis.spi.core.security.jaas.RolePrincipal -Djolokia.policyLocation=${ARTEMIS_INSTANCE_ETC_URI}jolokia-access.xml -Djon.id=amq"
